 ...
 * false (new StringID(s1)).equals(new StringID(s2)) may be true. Two StringID objects are regarded
 * as equal when s1 differs from s2 only in case or the umlaut expansion of s1 equals s2 (or vice
 * versa).
 */
public class StringID implements ID {
  ...
  public StringID clone() throws CloneNotSupportedException {
    // pavkovic 2003.07.08: we dont really clone this object as StringID are immutable after
    // creation
    return this;
  }
}
