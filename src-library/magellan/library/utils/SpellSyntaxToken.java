...
public class SpellSyntaxToken {
  ...
  /**
   * Enno 17.02.2007 in e-client 'c' = Zeichenkette 'k' = REGION|EINHEIT|STUFE|SCHIFF|GEBAEUDE 'i' =
   * Zahl 's' = Schiffsnummer 'b' = Gebaeudenummer 'r' = Regionskoordinaten (x, y) 'u' = Einheit '+'
   * = Wiederholung des vorangehenden Parameters '?' = vorangegangener Parameter ist nicht zwingend
   */
