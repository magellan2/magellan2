...
public class BestSkillComparator implements Comparator<Map<? extends ID, Skill>> {
   ...
   * 
   * @param bestComparator used to determine the best skill in each of the two collections of skills
   *          to be compared.
   ...
   */
  public BestSkillComparator(Comparator<? super Skill> bestComparator,
      Comparator<? super Skill> skillTypeComparator, Comparator<? super Skill> subComparator) {
    bestCmp = bestComparator;
    skillTypeCmp = skillTypeComparator;
