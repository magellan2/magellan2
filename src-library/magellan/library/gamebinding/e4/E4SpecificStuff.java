 ...
 */
public class E4SpecificStuff implements GameSpecificStuff {
  private static final String name = "Deveron";
  ...
  private E4OrderChanger orderChanger;
  ...
  public GameData createGameData(String iname) {
    return new CompleteData(getRules(), iname);
  }
  ...
  public void postProcess(GameData data) {
    E4PostProcessor.getSingleton().postProcess(data);
  }
  ...
  public void postProcessAfterTrustlevelChange(GameData data) {
    E4PostProcessor.getSingleton().postProcessAfterTrustlevelChange(data);
  }
  ...
  public RelationFactory getRelationFactory() {
    if (relationFactory == null) {
      relationFactory = new E4RelationFactory(getRules());
    }
  ...
  public MovementEvaluator getMovementEvaluator() {
    if (movementEvaluator == null) {
      movementEvaluator = new E4MovementEvaluator(rules);
    }
  ...
  public Completer getCompleter(GameData data, CompleterSettingsProvider csp) {
    return new E4OrderCompleter(data, csp);
  }
  ...
  public MessageRenderer getMessageRenderer(GameData data) {
    return new E4MessageRenderer(data);
  }
  ...
  public MapMergeEvaluator getMapMergeEvaluator() {
    if (mapMergeEvaluator == null) {
      mapMergeEvaluator = new E4MapMergeEvaluator(rules);
    }
  ...
  public GameSpecificOrderWriter getOrderWriter() {
    return E4OrderWriter.getSingleton();
  }
  ...
  public GameSpecificRules getGameSpecificRules() {
    if (gameSpecificRules == null) {
      gameSpecificRules = new E4GameSpecificRules(rules);
    }
    return gameSpecificRules;
  }

  public String getName() {
    return E4SpecificStuff.name;
  }
