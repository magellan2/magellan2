        ...
        if (r != null) {
          if ((me.getModifiers() & InputEvent.BUTTON1_MASK) != 0) {
            if ((me.getModifiers() & InputEvent.CTRL_MASK) != 0) {
              ...
              activeRegion = r;
              activeObject = r;
              // FIXME (stm) why does this event look different from the one generated by key
    ...
    addKeyListener(new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent e) {
        ...
        if (translationCoord != null) {
          ...
          // FIXME (stm) why does this event look different from the one generated after mousePressed?
//          dispatcher.fire(new SelectionEvent<Region>(mapper, null, activeRegion, SelectionEvent.ST_DEFAULT));
  ...
  public List<RenderingPlane> getPlanes() {
    ...
    /*
     * List p = new LinkedList(); for(int planeIndex = 0; planeIndex <
     * planes.length; planeIndex++) { if(planes[planeIndex] != null) {
     * p.add(planes[planeIndex]); } } return p;
     */
  }
