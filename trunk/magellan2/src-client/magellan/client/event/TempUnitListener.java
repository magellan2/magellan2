 ...
 * such events. Temp unit events are issued when a temporary unit is created or deleted.
 * 
 * @see TempUnitEvent
 * @see EventDispatcher
 */
public interface TempUnitListener extends magellan.library.event.EventListener {
  ...
  /**
   * Invoked when a temporary unit is deleted. Beware! It is not clear if the temp unit has already
   * been deleted from the GameData or not. You should not assume that it is in a sane state. This
   * might be a FIXME.
   */
