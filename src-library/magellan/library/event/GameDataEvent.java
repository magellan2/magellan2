...
public class GameDataEvent extends TimeStampedEvent {
  ...
  /**
   * Returns true if game data is freshly loaded (in contrast to a GameDataEvent with a changed game
   * data object that is only thrown if there are so many changes that single OrderConfirmEvent/
