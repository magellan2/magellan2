...
public interface CompletionGUI {
  ...
  /**
   * Called to cycle through multiple completions. Use the given index to find the completion that
   * should be shown. Following is guaranteed:
   * <ul>
   * <li>A call to offerCompletion was made before any cycleCompletion calls</li>
   * <li>The given parameters are the same used in the offerCompletion call</li>
   * </ul>
   */
