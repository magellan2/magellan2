...
public class DesktopEnvironment extends Object {
  ...
  static void init(MagellanDesktop md) {
    ...
    if (DesktopEnvironment.pendingSingleSCListeners != null) {
      Iterator<Pair<KeyStroke, ShortcutListener>> it =
          DesktopEnvironment.pendingSingleSCListeners.iterator();
    ...
    if (DesktopEnvironment.pendingAEListeners != null) {
      Iterator<Pair<KeyStroke, ActionListener>> it =
          DesktopEnvironment.pendingAEListeners.iterator();
  ...
  public static void registerShortcutListener(KeyStroke stroke, ShortcutListener sl) {
    if (DesktopEnvironment.initialized) {
      ...
      if (DesktopEnvironment.pendingSingleSCListeners == null) {
        DesktopEnvironment.pendingSingleSCListeners =
            new LinkedList<Pair<KeyStroke, ShortcutListener>>();
      }

      DesktopEnvironment.pendingSingleSCListeners.add(new Pair<KeyStroke, ShortcutListener>(stroke,
          sl));
    }
  }
