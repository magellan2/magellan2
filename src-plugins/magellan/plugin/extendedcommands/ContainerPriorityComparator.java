// class magellan.plugin.extendedcommands.ContainerPriorityComparator
 ...
 */
public class ContainerPriorityComparator implements Comparator<UnitContainer> {
  protected ExtendedCommands commands = null;

  /**
   * 
   */
  public ContainerPriorityComparator(ExtendedCommands commands) {
