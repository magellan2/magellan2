 ...
 * to load, set and save their positions. This variant uses the Java Docking Framework.
 * 
 ...
 * @author stm
 */
public class JDMagellanDesktop extends JPanel implements WindowListener, ActionListener,
    PreferencesFactory, DockingListener {
  private static final Logger log = Logger.getInstance(JDMagellanDesktop.class);

  private static JDMagellanDesktop _instance = null;
  ...
  // Split mode objects
  private JDDockingFrameworkBuilder dockingFrameworkBuilder;
   ...
   */
  protected JDMagellanDesktop() {
    // do nothing
  }

  public static JDMagellanDesktop getInstance() {
    if (JDMagellanDesktop._instance == null) {
      JDMagellanDesktop._instance = new JDMagellanDesktop();
    }
    return JDMagellanDesktop._instance;
  }
  ...
  public void init(Client client, MagellanContext context, Properties settings,
    ...
    JDDockingFrameworkBuilder.getInstance().setProperties(settings);
  ...
  protected void initDesktopMenu() {
    desktopMenu =
        JDDockingFrameworkBuilder.getInstance().createDesktopMenu(components, settings, this);
  }
  ...
  protected void setClientBounds() {
    ...
    JDMagellanDesktop.log.debug("ClientBounds: " + splitRect);
    client.setBounds(splitRect);
  }

  /**
   * Checks if all checkboxes in the menu are correctly set
   */
    ...
    if (splitRoot != null) {
      for (int i = 0; i < desktopMenu.getItemCount(); i++) {
        ...
        if (menuItem instanceof JCheckBoxMenuItem) {
          ...
          Dockable window = findDockingWindow(splitRoot, name);
          if (window != null) {
      ...
      JDDockingFrameworkBuilder.getInstance().updateLayoutMenu();
    }
  }
  ...
  protected boolean initSplitSet() {
    ...
    if (dockingFrameworkBuilder == null) {
      dockingFrameworkBuilder = JDDockingFrameworkBuilder.getInstance();
    }

    try {
      splitRoot =
          dockingFrameworkBuilder.buildDesktop(components, new File(settingsDir,
              JDMagellanDesktop.DOCKING_LAYOUT_FILE), client);
      if (splitRoot != null) {
        splitRoot.addDockingListener(this);
      }
    } catch (Exception exc) {
      JDMagellanDesktop.log.error(exc);
      return false;
    }
  ...
  public void repaintAllComponents() {
    JDMagellanDesktop.log.debug("repaint all");
  ...
  private Dockable findDockingWindow(CompositeDock root, String name) {
    if (root == null)
      return null;
    // if (root.getName() != null && root.getName().equals(name))
    // return root;

    for (int index = 0; index < root.getChildDockCount(); index++) {
      Dock sub = root.getChildDock(index);
      // sub.DockingWindow window = findDockingWindow(root.getChildWindow(index), name);
      // if (window != null)
      // return window;
    }
    return null;
      ...
      if (action != null && action.startsWith("menu.")) {
        ...
        if (splitRoot != null) {
          if (menu.isSelected()) {
            ...
            Dockable window = findDockingWindow(splitRoot, name);
            if (window != null) {
              window.setState(DockableState.CLOSED, null);// TODO dock
            } else {
  ...
  protected class KeyHandler {
    ...
    public void addStroke(KeyStroke str, Object dest, boolean actionAware) {
      ...
      if (shortCutListeners.containsKey(str) && dest != shortCutListeners.get(str)) {
        JDMagellanDesktop.log.warn("multiply used shortcut + " + str + "\n     old: "
    ...
    public void keyPressed(KeyStroke e, Object src) {
      ...
      JDMagellanDesktop.log.info("Error: Unrecognized key stroke " + e);
    }
  ...
  public void save() {
    ...
    try {
      dockingFrameworkBuilder.write(new File(settingsDir, JDMagellanDesktop.DOCKING_LAYOUT_FILE));
    } catch (Throwable t) {
      JDMagellanDesktop.log.fatal(t.getMessage(), t);
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowAdded(net.infonode.docking.DockingWindow,
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowClosed(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowClosing(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowDocked(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowDocking(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowMaximized(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowMaximizing(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowMinimized(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowMinimizing(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowRemoved(net.infonode.docking.DockingWindow,
  // * net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowRestored(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowRestoring(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowUndocked(net.infonode.docking.DockingWindow)
  // */
  ...
  // /**
  // * @see
  // net.infonode.docking.DockingWindowListener#windowUndocking(net.infonode.docking.DockingWindow)
  // */
   ...
   * @param listener
   */
  public void addDockingWindowListener(DockingListener listener) {
    if (splitRoot != null) {
      splitRoot.addDockingListener(listener);
    } else {
      JDMagellanDesktop.log.error("unable to add DockingWindowListener! (no RootWindow)");
    }
  }
  ...
  public void dockingChanged(DockingEvent event) {
    ...
    Object window;
    if (event.getOriginDock() == null && event.getDestinationDock() != null) {
      window = event.getSource();
      // if (addedWindow. != null) {
      // setActive(addedWindow.getName());
      // }
    } else if (event.getOriginDock() != null && event.getDestinationDock() == null) {
  ...
  public void dockingWillChange(DockingEvent arg0) {
    // do nothing
  }

  public static class RootWindow extends BorderDock {
