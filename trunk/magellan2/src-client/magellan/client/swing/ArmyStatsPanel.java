																		  ...
																		  SelectionListener
{
	...
	protected Collection<Item> getNonSkillWeapons(Unit unit, Collection<Skill> used, Collection<Item> col) {
		if(col == null) {
	...
	protected Map<Skill, Collection<Item>> getSkillsWithWeapons(Unit unit, Collection<Skill> skills, Map<Skill, Collection<Item>> map) {
