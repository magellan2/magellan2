...
public class OpenOrdersAccessory extends HistoryAccessory {
  ...
  public OpenOrdersAccessory(Properties setting, JFileChooser fileChooser) {
    ...
    chkAutoConfirm =
        new JCheckBox(Resources.get("openordersaccessory.chk.autoconfirmation.caption"));
    chkAutoConfirm
        .setToolTipText(Resources.get("openordersaccessory.chk.autoconfirmation.tooltip"));

    chkIgnoreSemicolonComments =
        new JCheckBox(Resources.get("openordersaccessory.chk.ignoresemicoloncomments.caption"));
    chkIgnoreSemicolonComments.setToolTipText(Resources
        .get("openordersaccessory.chk.ignoresemicoloncomments.tooltip"));

    chkDoNotOverwriteConfirmedOrders =
        new JCheckBox(Resources
            .get("openordersaccessory.chk.donotoverwriteconfirmedorders.caption"));
    chkDoNotOverwriteConfirmedOrders.setToolTipText(Resources
        .get("openordersaccessory.chk.donotoverwriteconfirmedorders.tooltip"));
