...
public class OrderEditorKit extends StyledEditorKit {
  ...
  /**
   * Fetches the order list for the editor. This is the list of orders supported by the superclass
   * augmented by the collection of orders defined locally for style operations.
   * 
