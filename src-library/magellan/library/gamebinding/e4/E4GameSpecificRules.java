...
import magellan.library.gamebinding.e3a.E3AGameSpecificRules;

/**
 * This class implements all Eressea specific rule informations.
 */
public class E4GameSpecificRules extends E3AGameSpecificRules {

  protected E4GameSpecificRules(Rules rules) {
    super(rules);
  }
}
