...
public class UnitSkillCountReplacer extends AbstractParameterReplacer implements
   ...
   * 
   * @param mode
   *          one if {@link #MODE_SKILL_MIN}, {@link #MODE_SKILL_MIN},
   *          {@link #MODE_SKILL_SUM}, {@link #MODE_SKILL_SUM_MIN}
   */
  ...
  /**
   * Counts all persons in the region. Can be restricted by unit filters. Can be
   * restricted by unit filters. The first parameter specifies the skill. If
   ...
   *          points of units with the given skill.<br />
   *          {@link #MODE_SKILL_SUM_MIN}: count all skill points of units with
   *          at least a certain skill level.
