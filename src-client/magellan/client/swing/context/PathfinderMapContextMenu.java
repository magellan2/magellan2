...
public class PathfinderMapContextMenu extends JMenu implements SelectionListener, GameDataListener{
  ...
  private GameData data;
	 ...
	 * (nur dann macht dieses Menü sinn
	 */
  ...
  private JMenuItem routebackSea = null;
    ...
    routebackLand = new JMenuItem(Resources.get("context.mapcontextmenu.menu.pathfinder.land.routeback"));
    ...
    routebackSea = new JMenuItem(Resources.get("context.mapcontextmenu.menu.pathfinder.land.routeback"));
   ...
   */
    ...
    if (mode==MOVE_NACH){
      ...
      order = getOrder(EresseaConstants.O_ROUTE) + " " + path + " " + getOrder(EresseaConstants.O_PAUSE);
    }
	...
	public void updateMenu(Region r){
	    ...
	    if (!this.unitsSelected){
	      ...
	      int i = countLandConnPossible(this.getSelectedUnits());
	      if (i==0){
	        nachLand.setEnabled(false);
          ...
          routebackLand.setEnabled(false);
          routebackLand.setText(Resources.get("context.mapcontextmenu.menu.pathfinder.land.routeback"));
	      } else if (i==1) {
	        // genau eine unit
	        nachLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.move"));
	        nachLand.setEnabled(true);
	        routeLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.route"));
          routeLand.setEnabled(true);
          routebackLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.routeback"));
          routebackLand.setEnabled(true);
	      } else {
	        // mehrere units
	        nachLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.move"));
	        nachLand.setEnabled(true);
	        routeLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.route"));
          routeLand.setEnabled(true);
          routebackLand.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.land.routeback"));
          routebackLand.setEnabled(true);
	      }
	      ...
	      i = countSeaConnPossible(this.getSelectedUnits());
        if (i==0){
          nachSea.setEnabled(false);
          ...
          // genau eine unit
          nachSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.move"));
          nachSea.setEnabled(true);
          routeSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.route"));
          routeSea.setEnabled(true);
          routebackSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.unit") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.routeback"));
          routebackSea.setEnabled(true);
        } else {
          // mehrere units
          nachSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.move"));
          nachSea.setEnabled(true);
          routeSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.route"));
          routeSea.setEnabled(true);
          routebackSea.setText(i + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.units") + " " + Resources.get("context.mapcontextmenu.menu.pathfinder.sea.routeback"));
          routebackSea.setEnabled(true);
        }
  ...
  private int countSeaConnPossible(Collection<Unit> c){
	...
	/**
	 * Prüfen ob für diese Unit eine Landverbindung zur destRegion
	 * möglich ist
	 */
	private boolean isLandConnPossible(Unit u){
	  ...
	  if (originRegion.equals(this.destRegion)){
	    return false;
	  }
	  // beide Region sollten kein Ozean sein
	  if (originRegion.getRegionType().isOcean() || this.destRegion.getRegionType().isOcean()){
	    return false;
	  }
	  // wenn jetzt noch auf gleicher Insel: OK
	  if (onSameIsland(originRegion, this.destRegion)){
	    return true;
	  }
	  return false;
	}
