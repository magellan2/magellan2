...
public class ErrorWindow extends JDialog implements ActionListener,WindowCloseable {
   ...
   *          durchgefÔøΩhrt und HVPWindow.shutdown aufgerufen. Wenn der Wert
   *          falsch ist, dann wird direkt System.exit aufgerufen und nur noch
   *          der Start-ShutdownHook Proze√ü wird gestartet.
   */
...
/**
 * Dies ist ein Bugfix f√ºr JTextArea in Verbindung mit JScrollPane. Nach dem
 * Einf√ºgen von Text wird die CaretPosition auf 0 gesetzt, um den Textinhalt von
 * oben nach unten lesen zu k√∂nnen. Au√üerdem wird beim Disablen die Farbe der
 * Komponente ge√§ndert und nicht wirklich disabled (weil sieht schei√üe aus...)
 * 
 * @author Thoralf Rickert
 * @version 29.10.2003
 */
...
/**
 * Dies ist ein Bugfix f¸r JEditorPane in Verbindung mit JScrollPane. Nach dem
 * Einf¸gen von Text wird die CaretPosition auf 0 gesetzt, um den Textinhalt von
 * oben nach unten lesen zu kˆnnen. Auﬂerdem wird beim Disablen die Farbe der
 * Komponente ge‰ndert und nicht wirklich disabled (weil sieht scheiﬂüe aus...)
 * 
 * @author Thoralf Rickert
 * @version 29.10.2003
 */
