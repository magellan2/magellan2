...
public class SkillComparator implements Comparator<Skill> {
   ...
   * 
   * @return a number &lt; 0 if o1's level is larger than the one of o2 or if both levels are equal
   *         and o1's days is larger than o2's. A number &gt; 0 is returned if o2's level is larger
   *         than o1's or if both levels are equal and o2's days is larger than o1's. 0 is returned
